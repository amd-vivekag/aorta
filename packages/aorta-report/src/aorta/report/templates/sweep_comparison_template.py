...
<tr>
<td>
{_image_or_placeholder(image_data.get('threads_sweep1', ''), 'Threads Sweep 1')}
</td>
<td>
{_image_or_placeholder(image_data.get('threads_sweep2', ''), 'Threads Sweep 2')}
</td>
</tr>
</table>
...
<tr>
<td>
{_image_or_placeholder(image_data.get('channels_sweep1', ''), 'Channels Sweep 1')}
</td>
<td>
{_image_or_placeholder(image_data.get('channels_sweep2', ''), 'Channels Sweep 2')}
</td>
</tr>
</table>
...
<tr>
<td>
{_image_or_placeholder(image_data.get('ranks_sweep1', ''), 'Ranks Sweep 1')}
</td>
<td>
{_image_or_placeholder(image_data.get('ranks_sweep2', ''), 'Ranks Sweep 2')}
</td>
</tr>
</table>
...
<tr>
<td>
{_image_or_placeholder(image_data.get('violin_sweep1', ''), 'Violin Sweep 1')}
</td>
<td>
{_image_or_placeholder(image_data.get('violin_sweep2', ''), 'Violin Sweep 2')}
</td>
</tr>
</table>
...
<tr>
<td>
{_image_or_placeholder(image_data.get('interaction_sweep1', ''), 'Interaction Sweep 1')}
</td>
<td>
{_image_or_placeholder(image_data.get('interaction_sweep2', ''), 'Interaction Sweep 2')}
</td>
</tr>
</table>
...
def _image_or_placeholder(image_data, alt_text):
    """Return image tag or placeholder if image is missing."""
    if image_data:
